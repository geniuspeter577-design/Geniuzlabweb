...
ROOT_URLCONF = 'backend.geniuzlab.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.automation.context_processors.automation_context',
                'backend.geniuzlab.context_processors.feature_flags',
            ],
        },
    },
]

WSGI_APPLICATION = 'backend.geniuzlab.wsgi.application'
