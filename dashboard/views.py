...
def home(request):
    ...
    cards = []
    try:
        from konnect.models import PortfolioItem
...
def dashboard(request):
    ...
    try:
        from konnect.models import CreativeProfile, Job, JobApplication, ServiceRequest
    ...
    try:
        from subs.models import UserSubscription
    ...
    if role == "customer":
        try:
            from konnect.models import ServiceRequest, SavedCreative
    ...
    if role == "creative" and creative_profile:
        try:
            from konnect.models import ServiceRequest
...
def project_detail(request, pk):
    from konnect.models import PortfolioItem, Follow, SavedProject
